                            ...
                            <table id="example" class="table table-hover table-dynamic">
                                ...
                                @foreach($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.blog.categories.edit', ['id' => $item->id]) }}" class="btn btn-sm btn-warning" title="Editar Categoria">
                                                <i class="fa fa-pencil-square-o"></i>
                                            </a>
                                            <a href="{{ route('admin.blog.categories.delete', ['id' => $item->id]) }}" class="btn btn-sm btn-danger">
