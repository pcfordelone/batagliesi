            ...
            <div class="breadcrumb-wrapper">
                <ol class="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="{{ route('admin.blog.posts.index') }}"><i class="fa fa-home"></i> Blog</a></li>
                        <li class="active"><i class="fa fa-user"></i> Criar Nova Postagem</li>
                    </ol>
                </ol>
            </div>
        </div>
                    ...
                    <div class="panel-content">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                ...
                                {!! Form::textarea('html_content', null, [
                                    'class'=>'form-control',
