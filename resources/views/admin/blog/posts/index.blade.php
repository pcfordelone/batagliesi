...
@section('page-content')
    ...
    <div class="page-content">
        <div class="header">
            <h2>
                Blog - <small>Posts Cadastrados</small>
            </h2>
            ...
            <div class="breadcrumb-wrapper">
                <ol class="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><i class="fa fa-journal"></i> Blog</li>
                    </ol>
                </ol>
            </div>
        </div>
                ...
                <div class="panel">
                    <div class="panel-content">
                        ...
                        <a href="{{ route('admin.blog.posts.create') }}">
                            <button class="btn btn-blue">NOVO POST</button>
                        </a>
                            ...
                            <table id="example" class="table table-hover table-dynamic">
                                ...
                                @foreach($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.blog.posts.edit', ['id' => $item->id]) }}" class="btn btn-sm btn-warning" title="Editar Categoria">
                                                <i class="fa fa-pencil-square-o"></i>
                                            </a>
                                            <a href="{{ route('admin.blog.posts.delete', ['id' => $item->id]) }}" class="btn btn-sm btn-danger">
