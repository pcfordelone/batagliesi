...
@section('page-content')
    ...
    <div class="page-content">
        <div class="header">
            <h2>
                Projetos - <small>Sub-categorias Cadastradas</small>
            </h2>
            ...
            <div class="breadcrumb-wrapper">
                <ol class="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><i class="fa fa-tag"></i> Sub-categorias Cadastradas</li>
                    </ol>
                </ol>
            </div>
        </div>
            ...
            <div class="col-lg-12 portlets">
                <div class="panel">
                    <div class="panel-content">
                        ...
                        <a href="{{ route('admin.projects.tags.create') }}">
                            <button class="btn btn-blue">NOVA SUB-CATEGORIA</button>
                        </a>
                            ...
                            <table id="example" class="table table-hover table-dynamic">
                                ...
                                @foreach($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.projects.tags.edit', ['id' => $item->id]) }}" class="btn btn-sm btn-warning" title="Editar Categoria">
                                                <i class="fa fa-pencil-square-o"></i>
                                            </a>
                                            <a href="{{ route('admin.projects.tags.delete', ['id' => $item->id]) }}" class="btn btn-sm btn-danger">
