...
@section('page-content')
    ...
    <div class="page-content">
        <div class="header">
            <h2>
                Usuários - <small>Inserir Novo Usuário</small>
            </h2>
            ...
            <div class="breadcrumb-wrapper">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><i class="fa fa-user-plus"></i> Adicionar Usuário</li>
                </ol>
            </div>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('role', $role, 'user', ['class'=>'form-control', 'required']) !!}
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {!! Form::input('password', 'password', null, [
                                        'class'=>'form-control',
                                        'placeholder'=>'Insira aqui sua a senha',
                                        'required'
                                    ]) !!}
                                </div>
                            </div>
