        ...
        <div class="header">
            ...
            <div class="breadcrumb-wrapper">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><i class="fa fa-user-plus"></i> Editar Perfil</li>
                </ol>
            </div>
        </div>
            ...
            <div class="col-lg-12 portlets">
                <div class="panel">
                    <div class="panel-content">
                        ...
                        <input type="hidden" name="user_profile_id" value="{{ $data->id }}" />

                        <div class="row">
                            <div class="col-md-2">
                                @if ($data->u_default_img != "")
                                    <img src="/uploads/users/{{ $data->u_default_img }}" style="height: 150px; width: 150px; border-radius: 100px; border: 3px solid lightgray;" />
                                @else
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('u_position', $data->u_position, [
                                                'class'=>'form-control',
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="prepend-icon">
                                                {!! Form::text('u_birthday', Carbon\Carbon::parse($data->u_birthday)->format('d/m/Y'), [
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('u_cellphone', $data->u_cellphone, [
                                                'class'=>'form-control',
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('u_phone', $data->u_phone, [
                                                'class'=>'form-control',
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('u_address', $data->u_address, [
                                                'class'=>'form-control',
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            {!! Form::input('number', 'u_number', $data->u_number, [
                                                'class'=>'form-control',
                                                'placeholder'=>'No.',
                                                ])
                                            !!}
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('u_complement', $data->u_complement, [
                                                'class'=>'form-control',
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('u_district', $data->u_district, [
                                                'class'=>'form-control',
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            {!! Form::select('u_uf', $ufs, $data->uf, ['class'=>'form-control', '', 'id' => 'estado']) !!}
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            {!! Form::label('u_country', 'País:') !!}
                                            {!! Form::text('u_country', $data->u_country, [
                                                'class'=>'form-control',
