            ...
            <div class="breadcrumb-wrapper">
                <ol class="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="{{ route('admin.awards.index') }}"><i class="fa fa-gift"></i> Premiações</a></li>
                        <li class="active"><i class="fa fa-plus"></i> Nova Premiação</li>
                    </ol>
                </ol>
            </div>
        </div>
            ...
            <div class="col-lg-12 portlets">
                <div class="panel">
                    <div class="panel-content">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                {!! Form::label('content', 'Observações:') !!}
