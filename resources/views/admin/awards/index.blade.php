...
@section('page-content')
    ...
    <div class="page-content">
        <div class="header">
            <h2>
                Prêmiações - <small>Prêmiações Cadastradas</small>
            </h2>
            ...
            <div class="breadcrumb-wrapper">
                <ol class="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><i class="fa fa-gift"></i> Prêmiações</li>
                    </ol>
                </ol>
            </div>
        </div>
                            ...
                            <table id="example" class="table table-hover table-dynamic">
                                ...
                                @foreach($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.awards.edit', ['id' => $item->id]) }}" class="btn btn-sm btn-warning" title="Editar">
                                                <i class="fa fa-pencil-square-o"></i>
                                            </a>
                                            <a href="{{ route('admin.awards.delete', ['id' => $item->id]) }}" class="btn btn-sm btn-danger" title="Apagar">
